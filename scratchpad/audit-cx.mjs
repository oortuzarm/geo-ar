...
// scripts/audit-cx.ts
var TARGET = "goal-customer-experience";
var required = [
  "\xBFC\xF3mo mejorar la experiencia de clientes?",
  "\xBFC\xF3mo mejorar la experiencia en tienda?",
  "\xBFC\xF3mo personalizar la experiencia del cliente?",
  "\xBFPuedo mostrar contenido cuando alguien llega?",
  "\xBFPuedo dar una bienvenida autom\xE1tica?",
  "\xBFC\xF3mo sorprender a mis clientes?",
  "\xBFC\xF3mo crear una experiencia diferente en mis sucursales?",
  "\xBFC\xF3mo generar una experiencia contextual?"
];
var extra = [
  "\xBFC\xF3mo hacer la visita m\xE1s atractiva?",
  "\xBFPuedo activar contenido cuando el cliente llega al local?",
  "\xBFC\xF3mo mejorar la experiencia presencial?",
  "\xBFC\xF3mo mostrar algo al llegar a mi sucursal?"
];
var regression = [
  { q: "\xBFC\xF3mo mejorar la experiencia en tienda con un QR?", expected: "faq-vs-qr" },
  ...
  { q: "\xBFC\xF3mo muestro contenido contextual por zona?", expected: TARGET }
  // OK si va a CX goal
];
var pass = 0;
