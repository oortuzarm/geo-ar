...
var CAPABILITY_TAG_LABELS = {
  studio: "Studio",
  api: "API",
  geopoints: "GeoPoints",
  presence: "Presencia f\xEDsica",
  analytics: "Analytics",
...
var DEFAULT_SOLUTION = {
  body: "Ubyca verifica si una persona estuvo f\xEDsicamente en un lugar \u2014 con hora exacta, duraci\xF3n y sin posibilidad de falsificaci\xF3n. Eso habilita casos muy distintos: registrar visitas de equipos en terreno, activar contenido o beneficios por presencia, medir tr\xE1fico real en ubicaciones, controlar acceso sin hardware, o demostrar que una campa\xF1a gener\xF3 presencia f\xEDsica. \xBFCu\xE1l de estos se acerca m\xE1s a lo que necesitas?",
  tags: ["GeoPoints", "Presencia f\xEDsica", "Analytics", "API"],
  matchedId: null
};
...
function matchSolution(query) {
  ...
  const subIntent = bestUc.subIntentions?.length ? detectSubIntention(bestUc.subIntentions, lower) : null;
  return {
...
// scripts/validate-p1.ts
var validations = [
  { id: "V1", q: "Quiero mostrarle una promoci\xF3n especial solo a los clientes que est\xE1n en el local en ese momento" },
  { id: "V2", q: "Quiero que cuando alguien llegue a mi tienda le aparezca autom\xE1ticamente una oferta del d\xEDa" },
  { id: "V3", q: "C\xF3mo hago para que una promoci\xF3n especial solo funcione dentro del local" },
  { id: "V4", q: "Quiero que los planos y precios se activen autom\xE1ticamente cuando un interesado llega al proyecto" },
  { id: "V5", q: "Quiero desbloquear contenido \xFAnicamente cuando una persona llegue a una ubicaci\xF3n espec\xEDfica" },
  { id: "V6", q: "Quiero que cierta informaci\xF3n solo aparezca cuando alguien entre a una zona determinada" },
  { id: "V7", q: "Quiero mostrar contenido diferente dependiendo de d\xF3nde est\xE9 una persona" }
];
...
console.log("\n\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
console.log("  VALIDACIONES P1 \u2014 ACTIVACI\xD3N DE CONTENIDO POR UBICACI\xD3N");
console.log("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\n");
...
var original50 = [
  // 1. GG
  { profile: "1-GG", q: "Quiero saber cu\xE1les de mis sucursales est\xE1n rindiendo mejor antes de decidir d\xF3nde abrir la pr\xF3xima", expectedWinnerId: "goal-decision-making" },
  { profile: "1-GG", q: "Necesito evidencia real para justificar una inversi\xF3n en una nueva zona" },
  { profile: "1-GG", q: "Tenemos 12 locales y no s\xE9 cu\xE1les generan m\xE1s valor" },
  { profile: "1-GG", q: "C\xF3mo decido si expandirme a una ciudad nueva sin tomar un riesgo ciego" },
  ...
  { profile: "2-GC", q: "Necesito comparar el rendimiento de mis locales para saber cu\xE1les necesitan intervenci\xF3n", expectedWinnerId: "goal-decision-making" },
  { profile: "2-GC", q: "C\xF3mo mido si una campa\xF1a de descuentos gener\xF3 tr\xE1fico real a la tienda", expectedWinnerId: "goal-attract-customers" },
  { profile: "2-GC", q: "Quiero saber en qu\xE9 horarios hay m\xE1s personas en mis tiendas para ajustar al equipo de ventas", expectedWinnerId: "goal-retail-stores" },
  { profile: "2-GC", q: "Necesito demostrarle al due\xF1o que nuestras acciones comerciales realmente generan visitas" },
  // 3. GM
  { profile: "3-GM", q: "Lanc\xE9 una activaci\xF3n en tres puntos de venta y no s\xE9 cu\xE1nta gente realmente particip\xF3" },
  { profile: "3-GM", q: "Quiero mostrarle una promoci\xF3n especial solo a los clientes que est\xE1n en el local en ese momento" },
  { profile: "3-GM", q: "C\xF3mo demuestro el ROI de una campa\xF1a presencial a mi directorio", expectedWinnerId: "brand-activation-campaign" },
  { profile: "3-GM", q: "Quiero que cuando alguien llegue a mi tienda le aparezca autom\xE1ticamente una oferta del d\xEDa" },
  { profile: "3-GM", q: "Necesito saber cu\xE1nto tiempo pasan las personas en cada zona de mis eventos para mejorarlos", expectedWinnerId: "goal-events" },
  // 4. GO
  { profile: "4-GO", q: "Mis t\xE9cnicos deben hacer rondas de mantenimiento y necesito saber si realmente fueron a cada punto", expectedWinnerId: "field-sales-supervision" },
  ...
  { profile: "4-GO", q: "C\xF3mo registro de forma confiable que un inspector municipal hizo su recorrido completo", expectedWinnerId: "municipalities-inspection" },
  // 5. RT
  { profile: "5-RT", q: "Quiero saber cu\xE1nta gente entra a mi tienda y en qu\xE9 horas hay m\xE1s movimiento", expectedWinnerId: "goal-retail-stores" },
  { profile: "5-RT", q: "C\xF3mo hago para que una promoci\xF3n especial solo funcione dentro del local" },
  { profile: "5-RT", q: "Quiero entender cu\xE1nto tiempo pasan mis clientes en la tienda", expectedWinnerId: "goal-retail-stores" },
  { profile: "5-RT", q: "Tengo una tienda f\xEDsica y tambi\xE9n un sitio web, quiero saber si los que visitan el sitio tambi\xE9n vinieron al local", expectedWinnerId: "goal-retail-stores" },
  { profile: "5-RT", q: "C\xF3mo atraigo a las personas que pasan por la puerta de mi local", expectedWinnerId: "local-business-proximity-promo" },
  // 6. GYM
  { profile: "6-GYM", q: "Quiero saber en qu\xE9 horarios se concentra m\xE1s la asistencia en cada sede" },
  { profile: "6-GYM", q: "Necesito comparar la frecuencia de asistencia entre mis diferentes gimnasios", expectedWinnerId: "goal-gyms" },
  { profile: "6-GYM", q: "C\xF3mo detecto qu\xE9 sedes tienen baja asistencia para tomar acci\xF3n antes de que sea un problema" },
  { profile: "6-GYM", q: "Quiero dar beneficios a los socios seg\xFAn cu\xE1ntas veces vinieron al gimnasio este mes", expectedWinnerId: "goal-gyms" },
  { profile: "6-GYM", q: "Necesito saber si mis campa\xF1as de retenci\xF3n est\xE1n generando m\xE1s visitas presenciales" },
  // 7. RST
  { profile: "7-RST", q: "Quiero saber cu\xE1l de mis locales recibe m\xE1s tr\xE1fico en la hora del almuerzo", expectedWinnerId: "spatial-concentration" },
  ...
  { profile: "7-RST", q: "C\xF3mo s\xE9 si mi campa\xF1a de descuentos de lunes gener\xF3 m\xE1s visitas que el lunes anterior" },
  { profile: "7-RST", q: "Quiero mostrar una oferta especial solo cuando el cliente est\xE9 cerca del restaurante" },
  { profile: "7-RST", q: "Necesito demostrar a mis inversores que la nueva sucursal est\xE1 generando el tr\xE1fico proyectado" },
  // 8. CC
  { profile: "8-CC", q: "Quiero saber qu\xE9 zonas del mall tienen m\xE1s tr\xE1fico y en qu\xE9 horarios", expectedWinnerId: "goal-shopping-centers" },
  { profile: "8-CC", q: "Necesito comparar el flujo de personas entre el sector A y el sector B para negociar rentas" },
  { profile: "8-CC", q: "C\xF3mo s\xE9 cu\xE1les son los pasillos y sectores m\xE1s y menos visitados de mi centro comercial", expectedWinnerId: "goal-shopping-centers" },
  { profile: "8-CC", q: "Quiero ver en tiempo real cu\xE1nta gente hay en cada piso o zona del mall", expectedWinnerId: "faq-indoor" },
  ...
  // 9. INM
  { profile: "9-INM", q: "Quiero saber cu\xE1ntas personas visitaron mi sala de ventas esta semana y cu\xE1nto tiempo estuvieron", expectedWinnerId: "goal-real-estate" },
  { profile: "9-INM", q: "C\xF3mo mido el inter\xE9s real en cada uno de mis proyectos inmobiliarios", expectedWinnerId: "goal-real-estate" },
  { profile: "9-INM", q: "Quiero que los planos y precios se activen autom\xE1ticamente cuando un interesado llega al proyecto" },
  { profile: "9-INM", q: "Necesito comparar cu\xE1ntas visitas recibi\xF3 cada sala de ventas sin depender del reporte del ejecutivo", expectedWinnerId: "goal-real-estate" },
  { profile: "9-INM", q: "C\xF3mo evito que el material exclusivo de mi open house circule fuera del proyecto" },
  // 10. CTO
  { profile: "10-CTO", q: "C\xF3mo se integra esto con nuestro sistema existente, tenemos un backend propio", expectedWinnerId: "faq-api-integration" },
  { profile: "10-CTO", q: "Necesito entender qu\xE9 datos entrega el sistema y en qu\xE9 formato" },
  { profile: "10-CTO", q: "Tenemos una app mobile propia en iOS y Android, c\xF3mo incorporamos la validaci\xF3n de ubicaci\xF3n" },
  { profile: "10-CTO", q: "Necesito integrar los datos de visitas con nuestro Salesforce" },
  { profile: "10-CTO", q: "Qu\xE9 diferencia hay entre esto y simplemente leer la geolocalizaci\xF3n del dispositivo nosotros mismos" }
];
console.log("\n\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
console.log("  REGRESI\xD3N: 50 PREGUNTAS ORIGINALES");
console.log("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\n");
var regressionOk = 0;
var regressionBroken = 0;
var broken = [];
