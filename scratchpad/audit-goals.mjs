...
// scripts/audit-goals.ts
var queries = [
  // goal-increase-sales
  { q: "\xBFC\xF3mo puedo aumentar las ventas en mi tienda f\xEDsica?", expected: "goal-increase-sales" },
  { q: "\xBFC\xF3mo vendo m\xE1s?", expected: "goal-increase-sales" },
  { q: "\xBFC\xF3mo mejorar los resultados de mi local?", expected: "goal-increase-sales" },
  // goal-attract-customers
  { q: "\xBFC\xF3mo atraigo m\xE1s clientes a mi local?", expected: "goal-attract-customers" },
  { q: "\xBFC\xF3mo llevo m\xE1s gente a mis sucursales?", expected: "goal-attract-customers" },
  { q: "\xBFC\xF3mo incremento el tr\xE1fico en mis locales?", expected: "goal-attract-customers" },
  // goal-improve-loyalty
  { q: "\xBFC\xF3mo fidelizo a mis clientes?", expected: "goal-improve-loyalty" },
  { q: "\xBFC\xF3mo logro que vuelvan mis clientes?", expected: "goal-improve-loyalty" },
  { q: "\xBFC\xF3mo aumento la frecuencia de visita?", expected: "goal-improve-loyalty" },
  // goal-measure-marketing-roi
  { q: "\xBFC\xF3mo mido el impacto de mis campa\xF1as?", expected: "goal-measure-marketing-roi" },
  { q: "\xBFC\xF3mo demuestro el retorno de una campa\xF1a?", expected: "goal-measure-marketing-roi" },
  // goal-improve-operations
  { q: "\xBFC\xF3mo controlo a mis equipos en terreno?", expected: "goal-improve-operations" },
  { q: "\xBFC\xF3mo s\xE9 si mis vendedores cumplieron la ruta?", expected: "goal-improve-operations" },
  // goal-choose-location
  { q: "\xBFD\xF3nde me conviene abrir mi nueva tienda?", expected: "goal-choose-location" },
  { q: "\xBFC\xF3mo elijo la mejor ubicaci\xF3n para expandirme?", expected: "goal-choose-location" },
  // Regresión — queries previas deben mantener su winner
  { q: "Tengo una cadena de restaurantes y quiero saber cu\xE1l de mis locales recibe m\xE1s visitas.", expected: "spatial-concentration" },
  { q: "Estoy evaluando abrir una nueva sucursal. \xBFC\xF3mo podr\xEDa ayudarme Ubyca?", expected: "urban-mobility-study" },
  { q: "\xBFPor qu\xE9 usar Ubyca en lugar de una landing con QR?", expected: "faq-vs-qr" }
];
var pass = 0;
var fail = 0;
