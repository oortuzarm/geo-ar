...
// scripts/audit-api.ts
var TARGET = "faq-api-integration";
var queries = [
  { q: "\xBFTiene API?", label: "tiene api" },
  { q: "\xBFTienen API?", label: "tienen api" },
  { q: "\xBFC\xF3mo se integra?", label: "se integra" },
  { q: "\xBFC\xF3mo se integra con mi sistema?", label: "se integra con mi sistema" },
  { q: "\xBFFunciona con mi app?", label: "funciona con mi app" },
  { q: "\xBFNecesito un desarrollador?", label: "necesito un desarrollador" },
  { q: "\xBFHace falta programar?", label: "hace falta programar" },
  { q: "\xBFNecesito un SDK?", label: "necesito un sdk" },
  { q: "\xBFCu\xE1nto tarda implementarlo?", label: "cuanto tarda implementarlo" },
  { q: "\xBFC\xF3mo conecto Ubyca con mi plataforma?", label: "conecto ubyca" },
  // Variantes adicionales
  { q: "\xBFNecesito programar para usarlo?", label: "sin programar" },
  { q: "\xBFCu\xE1nto tiempo tarda la integraci\xF3n?", label: "cuanto tiempo tarda" },
  { q: "\xBFSe puede integrar con mi web?", label: "se puede integrar" },
  { q: "\xBFFunciona con mi plataforma?", label: "funciona con mi plataforma" }
];
var regressionQueries = [
  { q: "Quiero integrar Ubyca con mi app", expected: "faq-app-integration" },
  { q: "\xBFTienen SDK para Android?", expected: "faq-app-integration" },
  { q: "\xBFNecesito hardware?", expected: "faq-no-hardware" }
];
var pass = 0;
console.log("\u2500\u2500 TABLA DE VALIDACI\xD3N PRINCIPAL \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500");
