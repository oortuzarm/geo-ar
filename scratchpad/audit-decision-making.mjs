...
// scripts/audit-decision-making.ts
var TARGET = "goal-decision-making";
var required = [
  "\xBFC\xF3mo puedo tomar mejores decisiones para mi negocio?",
  "\xBFC\xF3mo saber d\xF3nde invertir?",
  "\xBFC\xF3mo decidir qu\xE9 sucursal merece m\xE1s inversi\xF3n?",
  "\xBFC\xF3mo identificar oportunidades de crecimiento?",
  "\xBFC\xF3mo saber qu\xE9 local funciona mejor?",
  "\xBFC\xF3mo decidir d\xF3nde abrir una nueva sucursal?",
  "\xBFC\xF3mo comparar el desempe\xF1o de mis ubicaciones?",
  "\xBFC\xF3mo validar una estrategia antes de invertir?"
];
var regression = [
  ...
  { q: "\xBFC\xF3mo elegir d\xF3nde expandirme?", expected: "goal-choose-location" },
  { q: "\xBFD\xF3nde abrir mi pr\xF3xima tienda?", expected: "goal-choose-location" },
