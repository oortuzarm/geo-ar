...
// scripts/audit-presales.ts
var questions = [
  // 1. Gerente General
  { profile: "1-GG", label: "Gerente General", q: "Quiero saber cu\xE1les de mis sucursales est\xE1n rindiendo mejor antes de decidir d\xF3nde abrir la pr\xF3xima" },
  { profile: "1-GG", label: "Gerente General", q: "Necesito evidencia real para justificar una inversi\xF3n en una nueva zona" },
  { profile: "1-GG", label: "Gerente General", q: "Tenemos 12 locales y no s\xE9 cu\xE1les generan m\xE1s valor" },
  { profile: "1-GG", label: "Gerente General", q: "C\xF3mo decido si expandirme a una ciudad nueva sin tomar un riesgo ciego" },
  ...
  { profile: "2-GC", label: "Gerente Comercial", q: "Necesito comparar el rendimiento de mis locales para saber cu\xE1les necesitan intervenci\xF3n" },
  { profile: "2-GC", label: "Gerente Comercial", q: "C\xF3mo mido si una campa\xF1a de descuentos gener\xF3 tr\xE1fico real a la tienda" },
  { profile: "2-GC", label: "Gerente Comercial", q: "Quiero saber en qu\xE9 horarios hay m\xE1s personas en mis tiendas para ajustar al equipo de ventas" },
  { profile: "2-GC", label: "Gerente Comercial", q: "Necesito demostrarle al due\xF1o que nuestras acciones comerciales realmente generan visitas" },
  // 3. Gerente de Marketing
  { profile: "3-GM", label: "Gerente de Marketing", q: "Lanc\xE9 una activaci\xF3n en tres puntos de venta y no s\xE9 cu\xE1nta gente realmente particip\xF3" },
  { profile: "3-GM", label: "Gerente de Marketing", q: "Quiero mostrarle una promoci\xF3n especial solo a los clientes que est\xE1n en el local en ese momento" },
  { profile: "3-GM", label: "Gerente de Marketing", q: "C\xF3mo demuestro el ROI de una campa\xF1a presencial a mi directorio" },
  { profile: "3-GM", label: "Gerente de Marketing", q: "Quiero que cuando alguien llegue a mi tienda le aparezca autom\xE1ticamente una oferta del d\xEDa" },
  { profile: "3-GM", label: "Gerente de Marketing", q: "Necesito saber cu\xE1nto tiempo pasan las personas en cada zona de mis eventos para mejorarlos" },
  // 4. Gerente de Operaciones
  { profile: "4-GO", label: "Gerente de Operaciones", q: "Mis t\xE9cnicos deben hacer rondas de mantenimiento y necesito saber si realmente fueron a cada punto" },
  ...
  { profile: "4-GO", label: "Gerente de Operaciones", q: "C\xF3mo registro de forma confiable que un inspector municipal hizo su recorrido completo" },
  // 5. Dueño de Tienda Retail
  { profile: "5-RT", label: "Due\xF1o Retail", q: "Quiero saber cu\xE1nta gente entra a mi tienda y en qu\xE9 horas hay m\xE1s movimiento" },
  { profile: "5-RT", label: "Due\xF1o Retail", q: "C\xF3mo hago para que una promoci\xF3n especial solo funcione dentro del local" },
  { profile: "5-RT", label: "Due\xF1o Retail", q: "Quiero entender cu\xE1nto tiempo pasan mis clientes en la tienda" },
  { profile: "5-RT", label: "Due\xF1o Retail", q: "Tengo una tienda f\xEDsica y tambi\xE9n un sitio web, quiero saber si los que visitan el sitio tambi\xE9n vinieron al local" },
  { profile: "5-RT", label: "Due\xF1o Retail", q: "C\xF3mo atraigo a las personas que pasan por la puerta de mi local" },
  // 6. Cadena de Gimnasios
  { profile: "6-GYM", label: "Cadena de Gimnasios", q: "Quiero saber en qu\xE9 horarios se concentra m\xE1s la asistencia en cada sede" },
  { profile: "6-GYM", label: "Cadena de Gimnasios", q: "Necesito comparar la frecuencia de asistencia entre mis diferentes gimnasios" },
  { profile: "6-GYM", label: "Cadena de Gimnasios", q: "C\xF3mo detecto qu\xE9 sedes tienen baja asistencia para tomar acci\xF3n antes de que sea un problema" },
  { profile: "6-GYM", label: "Cadena de Gimnasios", q: "Quiero dar beneficios a los socios seg\xFAn cu\xE1ntas veces vinieron al gimnasio este mes" },
  { profile: "6-GYM", label: "Cadena de Gimnasios", q: "Necesito saber si mis campa\xF1as de retenci\xF3n est\xE1n generando m\xE1s visitas presenciales" },
  // 7. Cadena de Restaurantes
  { profile: "7-RST", label: "Cadena de Restaurantes", q: "Quiero saber cu\xE1l de mis locales recibe m\xE1s tr\xE1fico en la hora del almuerzo" },
  { profile: "7-RST", label: "Cadena de Restaurantes", q: "Necesito comparar el flujo de personas entre mis diferentes restaurantes" },
  { profile: "7-RST", label: "Cadena de Restaurantes", q: "C\xF3mo s\xE9 si mi campa\xF1a de descuentos de lunes gener\xF3 m\xE1s visitas que el lunes anterior" },
  { profile: "7-RST", label: "Cadena de Restaurantes", q: "Quiero mostrar una oferta especial solo cuando el cliente est\xE9 cerca del restaurante" },
  { profile: "7-RST", label: "Cadena de Restaurantes", q: "Necesito demostrar a mis inversores que la nueva sucursal est\xE1 generando el tr\xE1fico proyectado" },
  // 8. Centro Comercial
  { profile: "8-CC", label: "Centro Comercial", q: "Quiero saber qu\xE9 zonas del mall tienen m\xE1s tr\xE1fico y en qu\xE9 horarios" },
  ...
  { profile: "8-CC", label: "Centro Comercial", q: "C\xF3mo s\xE9 cu\xE1les son los pasillos y sectores m\xE1s y menos visitados de mi centro comercial" },
  { profile: "8-CC", label: "Centro Comercial", q: "Quiero ver en tiempo real cu\xE1nta gente hay en cada piso o zona del mall" },
  { profile: "8-CC", label: "Centro Comercial", q: "Necesito generar un reporte de afluencia por zona para presentar a los locatarios" },
  // 9. Inmobiliaria
  { profile: "9-INM", label: "Inmobiliaria", q: "Quiero saber cu\xE1ntas personas visitaron mi sala de ventas esta semana y cu\xE1nto tiempo estuvieron" },
  { profile: "9-INM", label: "Inmobiliaria", q: "C\xF3mo mido el inter\xE9s real en cada uno de mis proyectos inmobiliarios" },
  { profile: "9-INM", label: "Inmobiliaria", q: "Quiero que los planos y precios se activen autom\xE1ticamente cuando un interesado llega al proyecto" },
  { profile: "9-INM", label: "Inmobiliaria", q: "Necesito comparar cu\xE1ntas visitas recibi\xF3 cada sala de ventas sin depender del reporte del ejecutivo" },
  { profile: "9-INM", label: "Inmobiliaria", q: "C\xF3mo evito que el material exclusivo de mi open house circule fuera del proyecto" },
  // 10. CTO / Tecnología
  { profile: "10-CTO", label: "CTO / Tecnolog\xEDa", q: "C\xF3mo se integra esto con nuestro sistema existente, tenemos un backend propio" },
  { profile: "10-CTO", label: "CTO / Tecnolog\xEDa", q: "Necesito entender qu\xE9 datos entrega el sistema y en qu\xE9 formato" },
  { profile: "10-CTO", label: "CTO / Tecnolog\xEDa", q: "Tenemos una app mobile propia en iOS y Android, c\xF3mo incorporamos la validaci\xF3n de ubicaci\xF3n" },
  { profile: "10-CTO", label: "CTO / Tecnolog\xEDa", q: "Necesito integrar los datos de visitas con nuestro Salesforce" },
  { profile: "10-CTO", label: "CTO / Tecnolog\xEDa", q: "Qu\xE9 diferencia hay entre esto y simplemente leer la geolocalizaci\xF3n del dispositivo nosotros mismos" }
];
var results = questions.map(({ profile, label, q }) => {
