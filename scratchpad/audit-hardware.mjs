...
// scripts/audit-hardware.ts
var queries = [
  "\xBFNecesito hardware?",
  "\xBFRequiere hardware?",
  "\xBFNecesito instalar algo?",
  "\xBFFunciona sin sensores?",
  "\xBFNecesito beacons?",
  "\xBFHay que instalar algo en el local?",
  ...
  "\xBFNecesito dispositivos f\xEDsicos?"
];
var TARGET = "faq-no-hardware";
var pass = 0;
