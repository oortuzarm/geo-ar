        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            >
              ...
              {showTooltip && (
                <div className="absolute right-0 top-full mt-2 z-[9999] w-72 max-w-[280px] break-words bg-gray-800 border border-gray-700 text-xs text-gray-300 p-3 rounded-lg shadow-xl pointer-events-none">
                  {RADIUS_TOOLTIP}
                </div>
              )}
            </button>
