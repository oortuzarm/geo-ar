...
var goalDecisionMaking = {
  ...
  solution: "Puedes reemplazar opiniones, intuiciones o percepciones por datos reales de comportamiento f\xEDsico. Ubyca te ayuda a entender qu\xE9 ubicaciones funcionan mejor, d\xF3nde existe mayor oportunidad, qu\xE9 campa\xF1as generan resultados y d\xF3nde conviene concentrar recursos. El objetivo no es producir m\xE1s m\xE9tricas: es ayudarte a tomar decisiones con evidencia. Los datos provienen de presencia f\xEDsica verificada: cu\xE1ntas personas estuvieron en cada punto, cu\xE1nto tiempo permanecieron, en qu\xE9 horarios y c\xF3mo se distribuyeron entre ubicaciones. Puedes comparar el desempe\xF1o de sucursales, validar una zona antes de expandirte, medir si una campa\xF1a gener\xF3 visitas reales y priorizar inversiones donde los datos indican mayor retorno.",
...
var goalDigitalTransformation = {
  ...
  solution: "El mundo f\xEDsico y el digital ya no tienen que ser canales separados. Puedes conectar tus espacios f\xEDsicos \u2014 sucursales, locales, puntos de venta \u2014 con experiencias digitales que responden en tiempo real a lo que ocurre en ese espacio. Ubyca act\xFAa como la capa de datos que vincula la presencia f\xEDsica con tus sistemas digitales: detecta qui\xE9n est\xE1 en cada zona, genera eventos que tus plataformas pueden procesar y activa contenido, reglas o notificaciones basadas en ubicaci\xF3n verificada. Sin hardware adicional, sin instalaciones f\xEDsicas. Tu sitio web, app o backend recibe los datos de presencia y los convierte en acciones digitales.",
...
var goalMeasurePhysical = {
  ...
  solution: "El comportamiento de las personas en el mundo f\xEDsico genera muy pocos datos comparado con lo que ocurre online. Ubyca cambia eso: registra cu\xE1ntas personas estuvieron en cada ubicaci\xF3n, cu\xE1nto tiempo permanecieron, en qu\xE9 horarios hay m\xE1s actividad y c\xF3mo se distribuyeron entre zonas o sucursales. Es anal\xEDtica de comportamiento f\xEDsico \u2014 el equivalente de lo que una herramienta de anal\xEDtica web hace en el mundo digital, aplicado al mundo real. Puedes comparar el desempe\xF1o real de tus locales, identificar patrones de visita y tomar decisiones con datos observacionales, no con estimaciones. Ambas visiones pueden coexistir: lo digital te dice qu\xE9 hicieron en tu sitio, Ubyca te dice qu\xE9 hicieron en tu espacio.",
...
// scripts/audit-final.ts
var queries = [
  // ── CEO (10) ──────────────────────────────────────────────────────────────
  { profile: "CEO", q: "\xBFPor qu\xE9 deber\xEDa implementar Ubyca?", expected: "faq-why-ubyca" },
  { profile: "CEO", q: "\xBFQu\xE9 gano con Ubyca?", expected: "faq-why-ubyca" },
  { profile: "CEO", q: "\xBFC\xF3mo puedo tomar mejores decisiones para mi negocio?", expected: "goal-decision-making" },
  { profile: "CEO", q: "\xBFQu\xE9 problema resuelve Ubyca?", expected: "faq-why-ubyca" },
  { profile: "CEO", q: "\xBFCu\xE1l es la diferencia entre Ubyca y Google Analytics?", expected: "faq-vs-google-analytics" },
  { profile: "CEO", q: "\xBFNecesito hardware?", expected: "faq-no-hardware" },
  { profile: "CEO", q: "\xBFC\xF3mo saber qu\xE9 sucursal funciona mejor?", expected: "goal-decision-making" },
  { profile: "CEO", q: "\xBFC\xF3mo identificar oportunidades de crecimiento?", expected: "goal-decision-making" },
  { profile: "CEO", q: "\xBFC\xF3mo digitalizo mis sucursales?", expected: "goal-digital-transformation" },
  { profile: "CEO", q: "\xBFPara qu\xE9 sirve Ubyca?", expected: "faq-what-is-ubyca" },
  // ── Marketing (10) ───────────────────────────────────────────────────────
  { profile: "Marketing", q: "\xBFC\xF3mo mido el retorno de mis campa\xF1as?", expected: "goal-measure-marketing-roi" },
  { profile: "Marketing", q: "\xBFC\xF3mo justifico una inversi\xF3n en marketing?", expected: "goal-measure-marketing-roi" },
  { profile: "Marketing", q: "\xBFC\xF3mo demuestro impacto a mi cliente?", expected: "goal-measure-marketing-roi" },
  { profile: "Marketing", q: "\xBFC\xF3mo genero m\xE1s tr\xE1fico al local?", expected: "goal-attract-customers" },
  { profile: "Marketing", q: "\xBFC\xF3mo sorprendo a mis clientes?", expected: "goal-customer-experience" },
  { profile: "Marketing", q: "\xBFPor qu\xE9 usar Ubyca si ya tengo Google Analytics?", expected: "faq-vs-google-analytics" },
  { profile: "Marketing", q: "\xBFC\xF3mo personalizo la experiencia?", expected: "goal-customer-experience" },
  { profile: "Marketing", q: "\xBFC\xF3mo premio clientes frecuentes?", expected: "goal-improve-loyalty" },
  { profile: "Marketing", q: "\xBFC\xF3mo aumento mis ventas?", expected: "goal-increase-sales" },
  { profile: "Marketing", q: "\xBFC\xF3mo hacer marketing geolocalizado?", expected: "goal-marketing" },
  // ── Operaciones (10) ─────────────────────────────────────────────────────
  { profile: "Operaciones", q: "\xBFC\xF3mo controlo mis t\xE9cnicos?", expected: "goal-improve-operations" },
  { profile: "Operaciones", q: "\xBFC\xF3mo hago m\xE1s eficiente mi operaci\xF3n?", expected: "goal-improve-operations" },
  { profile: "Operaciones", q: "\xBFC\xF3mo saber qu\xE9 pasa en mis locales?", expected: "goal-measure-physical" },
  { profile: "Operaciones", q: "\xBFC\xF3mo medir lo que ocurre f\xEDsicamente?", expected: "goal-measure-physical" },
  { profile: "Operaciones", q: "\xBFC\xF3mo reduzco errores en terreno?", expected: "goal-improve-operations" },
  { profile: "Operaciones", q: "\xBFNecesito instalar algo en el local?", expected: "faq-no-hardware" },
  { profile: "Operaciones", q: "\xBFC\xF3mo auditar personal de campo?", expected: "goal-improve-operations" },
  { profile: "Operaciones", q: "\xBFC\xF3mo controlo mis rutas?", expected: "goal-improve-operations" },
  { profile: "Operaciones", q: "\xBFC\xF3mo medir permanencia en mis locales?", expected: "goal-measure-physical" },
  { profile: "Operaciones", q: "\xBFC\xF3mo verifico el cumplimiento operativo?", expected: "goal-improve-operations" },
  // ── Comercial (10) ───────────────────────────────────────────────────────
  { profile: "Comercial", q: "\xBFC\xF3mo impulso las ventas?", expected: "goal-increase-sales" },
  { profile: "Comercial", q: "\xBFC\xF3mo capto m\xE1s clientes?", expected: "goal-attract-customers" },
  { profile: "Comercial", q: "\xBFC\xF3mo fidelizo a mis clientes?", expected: "goal-improve-loyalty" },
  { profile: "Comercial", q: "\xBFC\xF3mo incentivo que vuelvan?", expected: "goal-improve-loyalty" },
  { profile: "Comercial", q: "\xBFC\xF3mo valido una zona antes de invertir?", expected: "goal-choose-location" },
  { profile: "Comercial", q: "\xBFC\xF3mo comparar el desempe\xF1o de mis ubicaciones?", expected: "goal-decision-making" },
  { profile: "Comercial", q: "\xBFC\xF3mo decidir d\xF3nde abrir una nueva sucursal?", expected: "goal-decision-making" },
  { profile: "Comercial", q: "\xBFC\xF3mo validar una estrategia antes de invertir?", expected: "goal-decision-making" },
  { profile: "Comercial", q: "\xBFC\xF3mo comparar sucursales?", expected: "goal-decision-making" },
  { profile: "Comercial", q: "\xBFCu\xE1l es la mejor zona para abrir?", expected: "goal-choose-location" },
  // ── Tecnología (10) ──────────────────────────────────────────────────────
  { profile: "Tecnolog\xEDa", q: "\xBFTiene API?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFC\xF3mo se integra con mi sistema?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFNecesito un SDK?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFCu\xE1nto tarda implementarlo?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFNecesito desarrollador?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFC\xF3mo digitalizar puntos f\xEDsicos?", expected: "goal-digital-transformation" },
  { profile: "Tecnolog\xEDa", q: "\xBFC\xF3mo conectar el mundo f\xEDsico con el digital?", expected: "goal-digital-transformation" },
  { profile: "Tecnolog\xEDa", q: "\xBFFunciona con mi app?", expected: "faq-api-integration" },
  { profile: "Tecnolog\xEDa", q: "\xBFC\xF3mo obtener datos del comportamiento presencial?", expected: "goal-measure-physical" },
  { profile: "Tecnolog\xEDa", q: "\xBFFunciona sin hardware?", expected: "faq-no-hardware" }
];
var profileStats = {
  ...
  "Tecnolog\xEDa": { correct: 0, falsePos: 0, def: 0, total: 0 }
};
var globalStats = { correct: 0, falsePos: 0, def: 0 };
var failures = [];
...
\u2500\u2500 ${profile.toUpperCase()} \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
  ...
  if (result === "CORRECT") {
    profileStats[profile].correct++;
    globalStats.correct++;
  } else if (result === "DEFAULT") {
    profileStats[profile].def++;
    globalStats.def++;
  } else {
    profileStats[profile].falsePos++;
    globalStats.falsePos++;
    failures.push({ profile, q, expected, got: id, type: result });
  }
...
for (const [p, s] of Object.entries(profileStats)) {
  ...
  console.log(`${p.padEnd(14)} ${String(s.correct).padEnd(10)} ${String(s.falsePos).padEnd(8)} ${String(s.def).padEnd(8)} ${s.total} (${pct2}%)`);
}
var total = 50;
var pct = Math.round(globalStats.correct / total * 100);
console.log("\n\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
